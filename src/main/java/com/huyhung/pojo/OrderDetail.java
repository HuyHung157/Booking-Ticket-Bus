...
@NamedQueries({
    ...
    @NamedQuery(name = "OrderDetail.findBySeatOrder", query = "SELECT o FROM OrderDetail o WHERE o.seatOrder = :seatOrder"),
    ...
    @NamedQuery(name = "OrderDetail.findByIsArchive", query = "SELECT o FROM OrderDetail o WHERE o.isArchive = :isArchive")})
public class OrderDetail implements Serializable {
    ...
    public OrderDetail(Integer id, String seatOrder, boolean isActive, boolean isArchive) {
        this.id = id;
    ...
    public TripDetail getTripDetailId() {
        return tripDetailId;
    }

    public void setTripDetailId(TripDetail tripDetailId) {
